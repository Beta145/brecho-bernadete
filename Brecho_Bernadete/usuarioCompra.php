...
<head>
	...
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="css/style_usuario_compra.css">
...
<div id="main">
    ...
    <div id="usuario_compras">
        <div id="menu_usuario">
            <div class="opc_usuario" style="background-color: #696969;" ><a href="#" style="text-decoration: none;">Compras</a></div>  
            <a href="usuarioVenda.php" style="text-decoration: none;">          
                <div class="opc_usuario" >Vendas</div>
            </a>
            <a href="#" style="text-decoration: none;">
                <div class="opc_usuario">Dados</div>
            </a>
