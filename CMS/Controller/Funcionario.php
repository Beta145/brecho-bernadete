    ...
    class FuncionarioControl{
        ...
        public function obterTodos(){
            ...
            foreach ($listaFuncionarios as $funcionario) {
                ...
                echo('<a href="cadastro_funcionario.php"><img src="Imagens/editar.png" alt="Editar Funcionário" onclick="obterUm('.$funcionario->getId().')" style="width:40px;height:40px;margin-left:10px;"></a>');
                echo('<img src="Imagens/check_true.png" alt="Ativar/Desativar Funcionário" onclick="atualizarSituacao('.$funcionario->getId().')">');
                echo('</td>');
                echo('</tr>');
        ...
        public function obterUm(){
            ...
            echo(json_encode($funcionarioDAO->obterUm($_POST["id"])));
